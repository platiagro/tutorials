...
O Coeficiente de determinação (ou R²), corresponde à correlação ao quadrado entre os valores de resultado observados e os valores previstos pelo modelo.

### Retorno esperado no experimento

Retorna a curva da distribuição do erro na regressão, exemplificada pela imagem a seguir:
